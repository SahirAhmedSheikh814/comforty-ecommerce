...
const sliderSettings = {
  ...
  responsive: [
    {
      breakpoint: 1280, // Devices with screen width >= 1280px (e.g., iPad Air Pro, larger tablets)
      settings: {
...
const OurProducts = () => {
  ...
  return (
    <div className="p-8 gap-4 bg-white min-h-full">
      <h2 className="text-3xl text-center font-bold my-8 mb-12">Our Products</h2>
      ...
      {/* Second Slider (added below the first one) */}
